...
VALUES
(1, 'John Doe', 30, 'Male', '123 Main St, New York, USA', 'Homicide', 'Incarcerated', 'Richard Doe', '2024-01-11', NULL, 'Rikers Island', NULL, 1),
(2, 'Jane Smith', 28, 'Female', '456 Oak St, Toronto, Canada', 'Fraud', 'Released', 'Michael Smith', '2023-11-06', '2024-02-15', 'Toronto Prison', NULL, 2),
(3, 'Carlos Sanchez', 35, 'Male', '789 Pine St, London, UK', 'Drug Trafficking', 'Incarcerated', 'Juan Sanchez', '2024-03-17', NULL, 'London Prison', NULL, 3),
(4, 'Olivia Brown', 40, 'Female', '321 Birch St, Los Angeles, USA', 'Assault', 'Released', 'Lucas Brown', '2024-02-11', '2024-04-05', 'Los Angeles Correctional Facility', NULL, 4),
(5, 'Michael Adams', 32, 'Male', '987 Cedar St, Berlin, Germany', 'Cybercrime', 'Incarcerated', 'Henry Adams', '2024-04-26', NULL, 'Berlin Prison', NULL, 5),
(6, 'Sophia Clark', 27, 'Female', '654 Elm St, Paris, France', 'Kidnapping', 'Released', 'David Clark', '2024-05-10', NULL, 'Paris Prison', NULL, 6),
(7, 'James Wilson', 38, 'Male', '321 Willow St, Madrid, Spain', 'Bribery', 'Incarcerated', 'Andrew Wilson', '2024-06-13', NULL, 'Madrid Prison', NULL, 7),
(8, 'Emma Taylor', 45, 'Female', '432 Maple St, Sydney, Australia', 'Burglary', 'Released', 'George Taylor', '2024-08-05', NULL, 'Sydney Prison', NULL, 8),
(9, 'William Anderson', 50, 'Male', '876 Cedar St, Cape Town, South Africa', 'Arson', 'Incarcerated', 'Paul Anderson', '2024-07-23', NULL, 'Cape Town Prison', NULL, 9),
(10, 'Charlotte White', 28, 'Female', '987 Oak St, Chicago, USA', 'Robbery', 'Released', 'Mark White', '2024-08-29', NULL, 'Chicago Jail', NULL, 10);
...
SELECT TOP 1 ch.Hearing_Id, ch.Hearing_Date, ch.Hearing_Time, ch.Court_Name,  
...
SELECT TOP 3 o.Officer_id, o.First_Name, o.Last_Name, COUNT(c.Case_Id) AS Case_Count
FROM Officers o
...
CREATE OR ALTER TRIGGER trg_Insert_Criminal
ON Criminals
AFTER INSERT
AS
BEGIN
...
CREATE OR ALTER TRIGGER trg_Update_Criminal
ON Criminals
AFTER UPDATE
AS
BEGIN
